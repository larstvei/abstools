...
/**
 * Generates the Erlang module for testing one class
 *
 * @author Lars Tveito, Hans-Dieter Hiep
 *
 */
public class TestingClassGenerator {
    ...
    public TestingClassGenerator(ErlApp ea, ClassDecl classDecl) throws IOException {
        this.classDecl = classDecl;
        modName = ErlUtil.getTestingName(classDecl);
